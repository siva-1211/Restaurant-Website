...
<div class="container-fluid">
    ...
    <form class="container d-flex justify-content-center align-items-center vh-100">
        <div class="details d-flex-column">
          ...
          <div class="loginbutton d-flex justify-content-center"><button type="submit" onclick="signup.js" class="signinbutton">LOGIN</button>

        </div>
         <div class="content d-flex justify-content-center">Don't have an Account?<a href="createaccount.html" class="signup">Create an Account</a></div> 
        </div>
