...
<head>
    ...
    <title>Los Pollos Account</title>
...
<div class="container-fluid">
    <div class="row">
      <header class="header">
        <nav class="navbar">
          ...
          <a href="login.html"> <button class="button" onclick="">Login</button></a>
    ...
    <form class="container d-flex justify-content-center align-items-center vh-100" action="dbconnect.php" method="POST">
        <div class="details d-flex-column">
         ...
         <div class="content d-flex justify-content-center">Already have an Account?<a href="login.php" class="signup">Login</a></div> 
        </div>
